...
import empeetexGif from '../../../../public/gif/empeetex.gif'
            ...
            <div className='flex flex-wrap items-center gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-4'>
              ...
              <div className={styles.company + ' flex items-center'}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://stylabs.com/">Stylabs</a>
              </div>
              <button
            ...
            </div>
            {
              !isExpanded &&
                            ...
                            <div className={pageStyles.description}>
                                ...
                                In addition ... <button onClick={() => setIsExpanded(true)}
                                className='font-semibold text-green-500 tracking-wider'>read more</button>
                            </div>
            }
            ...
            }
            {
              isExpanded &&
                            <div className={pageStyles.description}>
                                ...
                                className='font-semibold text-green-500 tracking-wider'>read less</button>
            ...
            <div className='flex flex-wrap items-center gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-4'>
              ...
              <div className={styles.company + ' flex items-center'}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.iifl.com/">India Infoline Finance Limited</a>
              </div>
              <button
          ...
          <div className="flex flex-col md:flex md:flex-row items-center">
            <div className="space-y-4 md:space-y-5">
              ...
              <div className='mx-auto w-full md:w-3/4 lg:w-2/3 2xl:w-1/3'>
                ...
                <Image className="h-auto object-contain"
                  src={empeetexGif}
                  title="Empeetex"
                  alt="Empeetex GIF"
                  unoptimized
...

              {
                !isExpanded &&
                                ...
                                <p className={pageStyles.description}>
                                    I also managed ... <button onClick={() => setIsExpanded(true)}
                                    className='font-semibold text-green-500 tracking-wider'>read more</button>
                                </p>
              }
            ...
            <div className='flex flex-wrap items-center gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-4'>
              ...
              <div className={styles.company + ' flex items-center'}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://neuraltechsoft.com/">NueralTechSoft</a>
              </div>
