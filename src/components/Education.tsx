                ...
                <div className="md:flex-1 pl-6 pt-5 md:pl-8 pr-1">
                    <ol className="relative border-s border-my-voilet-2">
                        <li className="mb-10 ms-6 space-y-3">
                            ...
                            <div className="flex items-center space-x-2 mb-2 text-md text-slate-50 font-normal ">
                            ...
                            <p className="text-justify mb-4 text- font-normal text-slate-200">{masters.body}</p>
                        </li>
                        <li className="mb-2 ms-6 space-y-3">
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold  text-my-yellow">{bachelors.title}</h3><div className="flex items-center space-x-2 mb-2 text-md text-slate-50 font-normal ">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.5 -0.5 16 16"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    id="Location--Streamline-Mynaui"
                            ...
                            <p className="text-justify mb-4 text- font-normal text-slate-200">{bachelors.body}</p>
                        </li>
                    </ol>
                </div>
