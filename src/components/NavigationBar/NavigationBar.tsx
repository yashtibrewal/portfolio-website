    ...
    return (
        <nav>
            ...
            <div className="md:hidden">
                <div
                    onClick={togglePanel}
                    className="fixed top-5 z-40 right-5 bg-my-yellow rounded-xl p-2 visible">
                    <div>
                ...
                <div className={`z-40 border-my-blue border-y-4 border-r-4 bg-my-blue-2 fixed left-0 transform transition duration-300 ${isPanelOpen ? 'translate-x-0' : '-translate-x-full'}
