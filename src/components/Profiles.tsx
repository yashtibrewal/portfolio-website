    ...
    return (
        ...
        >
            ...
            <span className=''><a className='' href='tel:+13528713427'>Phone</a></span> */}
                ...
                <a
                    ...
                    <svg className="mx-auto w-12 lg:w-14 fill-blue-400 animate-pulse" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
		...
		c3.8-9.6,12.1-19.6,27-19.6c19.5,0,28.3,14.8,28.3,36.4v82.6H241v-88.8C241,369.9,213.2,346.9,177.7,346.9z"/>
                ...
                <a
                    ...
                    <svg className="mx-auto w-12 lg:w-14 fill-blue-400  animate-pulse"
                ...
                <a target="_blank" rel="noreferrer" href='https://www.hackerrank.com/profile/yashtibrewal'>
                    <svg className="mx-auto w-14 lg:w-16 fill-blue-400  animate-pulse" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
