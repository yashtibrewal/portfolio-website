...
export default function Profiles() {
    ...
    return (
        <div>
            <div id="profiles" className="flex flex-wrap items-center justify-around">
                <a
                    className={`${styles.profile} ${styles.animate_fade_in_left}`}
                    target="_blank"
                    rel="noreferrer"
                    href='https://www.linkedin.com/in/yash-tibrewal/'
                >
                    <svg className="w-10 lg:w-14 xl:w-20 " version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
		...
		c3.8-9.6,12.1-19.6,27-19.6c19.5,0,28.3,14.8,28.3,36.4v82.6H241v-88.8C241,369.9,213.2,346.9,177.7,346.9z"/>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href='https://github.com/yashtibrewal'
                >
                    <svg className="w-10 lg:w-14 xl:w-20 "
                ...
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href='https://www.hackerrank.com/profile/yashtibrewal'
                >
                    <svg className="w-10 lg:w-14 xl:w-20 " viewBox="2 2 28 29" xmlns="http://www.w3.org/2000/svg">
