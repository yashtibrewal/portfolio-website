...
function Projects() {
    return (
        <div id="projects" className="space-y-10">
            <div className={pageStyles.section_heading}>03. Projects</div>
            <div className={pageStyles.sub_section_spacing}>
                <div className="flex flex-col md:flex md:flex-row items-center">
                    <div className="md:w-1/2 space-y-4 md:space-y-5">
                        <h1 className={`${pageStyles.section_sub_heading} flex items-center`}>Pulse Pricing Page Clone <Latest></Latest></h1>
                        <div className="space-x-3">
                            <a
                                className={pageStyles.button}
                                target="_blank" href="https://pulse-pricing-mock.onrender.com/">Live link</a>
                            <a
                                className={pageStyles.button}
                        ...
                        <p className={pageStyles.description}>
                            For this project, I recreated the <a target="_blank" href="https://pulseapp.com/pricing" className="underline underline-offset-2">pricing page of Pulse</a>, a popular app, using Tailwind CSS.
                    ...
                    <div className="-ml-12 sm:-ml-20 md:ml-0 md:w-1/2 relative md:scale-125 xl:scale-100 hover:scale-110">
                        <div className="flex justify-center items-center">
                            <img className="w-3/4 h-auto object-contain" src="desktop-mockup-pulse-pricing.png"
                                title="Desktop mockup of Pulse pricing page" alt="Desktop mockup of Pulse pricing page" />
                            <img className="w-1/4 h-auto object-contain absolute right-5 top-0" src="mobile-mockup-pulse-pricing.png"
                ...
                <div className="flex flex-col md:flex md:flex-row items-center">
                    <div className="md:w-1/2 space-y-4 md:space-y-5">
                        <h1 className={pageStyles.section_sub_heading}>Podia Product Page Clone</h1><div className="space-x-3">
                            <a
                                className={pageStyles.button}
                                target="_blank" href="https://podia-products-mockup.onrender.com/">Live link</a>
                            <a
                                className={pageStyles.button}
                        ...
                        {/* Details */}
                        <p className={pageStyles.description}>
                            For this project, I recreated the <a target="_blank" href="https://www.podia.com/digital-products" className="underline underline-offset-2">products page of Podia</a>, a popular app, using Tailwind CSS.
                    ...
                    <div className="-ml-12 sm:-ml-20 md:ml-0 md:w-1/2 relative md:scale-125 xl:scale-100 hover:scale-110">
                        <div className="flex justify-center items-center">
                            <img className="w-3/4 h-auto object-contain" src="desktop-mockup-podia-product.png" title="Desktop mockup of Podia Product page" alt="Desktop mockup of Podia Product page" />
                            <img className="w-1/4 h-auto object-contain absolute right-5 top-0" src="mobile-mockup-podia-product.png" title="Mobile mockup of Podia product page" alt="Mobile mockup of Podia product page" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col md:flex md:flex-row items-center">
                    <div className="md:w-1/2 space-y-4 md:space-y-5">
                        <h1 className={pageStyles.section_sub_heading}>Spam Number Detection</h1>
                        <div className="space-x-3">
                            <a
                                className={pageStyles.button}
                                target="_blank" href="https://github.com/yashtibrewal/number-spam-detector-backend">Github</a>
                    ...
                    <div className="-ml-12 sm:-ml-20 md:ml-0 md:w-1/2 relative md:scale-125 xl:scale-100 hover:scale-110">
                        <div className="flex justify-center items-center">
                            <img className="w-3/4 h-auto object-contain" src="spam-number-detection-code.png"
